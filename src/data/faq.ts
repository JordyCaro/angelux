...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Si estás enfermo, con fiebre, infección activa, piel quemada o herida, resaca o alcohol en sangre. Tampoco con el sistema inmune bajo, tratamientos que alteren la coagulación, o si hay duda médica. Embarazo y lactancia: esperá. Un tatuaje pide piel sana y cuerpo descansado.",
  },
  {
    q: "¿Duele?",
    a: "Duele, y no vale la pena mentir. Cambia según zona, tamaño y tu umbral. Costillas, pie y columna suelen hablar más; brazo y muslo, menos. Dormí, comé e hidratate. El dolor es parte del rito, no el centro de la pieza.",
  },
  {
